...
{
    /// <inheritdoc />
    public partial class wholeNewsBlock : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Albums_News_NewsId",
                        column: x => x.NewsId,
                        principalTable: "News",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Albums_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    FnameOrig = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    FnameSmall = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    FnameBig = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsTitlePhotos", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Albums_NewsId",
                table: "Albums",
                column: "NewsId");

            migrationBuilder.CreateIndex(
                name: "IX_Albums_TeamId",
                table: "Albums",
                column: "TeamId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsTitlePhotos_NewsId",
                table: "NewsTitlePhotos",
                column: "NewsId");

            migrationBuilder.CreateIndex(
                name: "IX_NewsTitlePhotos_PhotoId",
                table: "NewsTitlePhotos",
                column: "PhotoId");
